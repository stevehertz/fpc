        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <p class="mb-4">
                    ...
                    knowledge of the agriculture industry and a strong desire to promote a prosperous and sustainable
                    sector.
                </p>
                ...
                <div class="row g-4 align-items-center">
                        ...
                        <div class="row g-4">
                            <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                <div class="text-center rounded py-5 px-4"
                                    ...
                                    <h4 class="mb-0">Complete Industry Experience</h4>
                                </div>
                            </div>
                            <div class="col-12 wow fadeIn" data-wow-delay="0.5s">
                                <div class="text-center rounded py-5 px-4"
                                    ...
                                    <h4 class="mb-0">Robust network</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 wow fadeIn" data-wow-delay="0.7s">
                        <div class="text-center rounded py-5 px-4" style="box-shadow: 0 0 45px rgba(0,0,0,.08);">
                            ...
                            <h4 class="mb-0">Speak Up and Be Represented</h4>
                        </div>
                    </div>
                </div>
            </div>
